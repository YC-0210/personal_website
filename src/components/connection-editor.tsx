  ...
  return (
    <>
      {selectedConnections.length > 0 && !pendingConnection && (
        <ul className="border-hairline bg-surface-1 fixed right-4 bottom-28 z-20 w-72 max-w-[calc(100vw-2rem)] space-y-1 rounded-lg border p-2 text-xs max-md:top-28 max-md:bottom-auto">
      ...
      */}
      ...
      <div className="fixed right-4 bottom-16 z-20 flex items-center gap-2 text-sm max-md:top-16 max-md:bottom-auto">
