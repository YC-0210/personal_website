...
function Workspace({ article }: { article: Article }) {
  ...
  return (
    <main className="bg-canvas min-h-dvh">
      ...
      */}
      <div className="mx-auto max-w-md px-6 py-16 lg:hidden">
        ...
        <p className="text-ink-subtle mt-3 text-sm leading-relaxed">
          ...
          screen. This is a deliberate exception to the mobile parity the rest of
          the site keeps — not an oversight.
        </p>
        <p className="text-ink-subtle mt-3 text-sm leading-relaxed">
          You can still read &ldquo;{article.title}&rdquo;, and publish it if it
          is ready.
        </p>
