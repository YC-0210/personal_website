  ...
  return (
    <main className="fixed inset-0 overflow-hidden">
      ...
      */}
      ...
      {/* ADR-0004 temporary: way into the mobile-Dossier prototypes. Removed with /proto. */}
      <a
        href="/proto"
        className="border-hairline bg-surface-1 text-ink-subtle fixed top-4 right-4 rounded-md border px-3 py-1.5 text-sm font-medium"
      >
        Prototypes
      </a>
